...
def update_metadata(doc_id: int, title: str, description: str, tags: List[str]) -> Tuple[bool, str]:
    """
    ...
    try:
        ...
        logger.error(f"Fehler beim Aktualisieren der Metadaten für Dokument {doc_id}: {str(e)}")
