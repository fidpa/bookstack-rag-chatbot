...
class AzureProvider(LLMProvider):
    ...
    def __init__(self):
        ...
        if AZURE_SDK_AVAILABLE and self.api_key and self.endpoint:
            try:
                ...
                logger.info(f"Azure OpenAI provider initialised with endpoint: {self.endpoint}")
    ...
    def _make_api_call(self, deployment_name: str, messages: List[Dict], 
    ...
    def chat(self, messages: List[Dict[str, str]], model: str = 'azure-gpt-35-turbo', 
        ...
        try:
            ...
            if "deployment" in error_msg and "not found" in error_msg:
                return (f"Error: Azure deployment '{deployment_name}' not found.\n"
            ...
            if "403" in error_msg and ("firewall" in error_msg or "virtual network" in error_msg):
    ...
    def _make_streaming_call(self, deployment_name: str, messages: List[Dict],
                           temperature: float, max_tokens: int, **kwargs):
    ...
    def stream_chat(self, messages: List[Dict[str, str]], model: str = 'azure-gpt-35-turbo',
    ...
    def complete(self, prompt: str, model: str = 'azure-gpt-35-turbo',
                 temperature: float = 0.7, max_tokens: int = 1000, **kwargs) -> str:
        """
